...
//接收状态
//bit15，	接收完成标志
//bit14，bit13	接收到0x50，接收到命令10，接收到数据01
//bit11~0，	接收到的有效字节数目（4096个最多）
...
void UART4_IRQHandler(void)                	//串口1中断服务程序
{
	...
	OSIntEnter();
#endif
	if (USART_GetITStatus(UART4, USART_IT_RXNE) != RESET)			//接收中断，接收到的数据如果第二个字节是0x50，则它是命令。
	{
